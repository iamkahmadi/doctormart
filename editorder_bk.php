        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="input-states">
              <form class="row" method="POST" action="php_action/editOrder.php" id="editOrderForm">
                ...
                $sql = "SELECT orders.id, orders.orderDate, orders.clientName, orders.clientContact, orders.subTotal, orders.totalAmount,orders.discount, orders.grandTotalValue, orders.paid, orders.dueValue, orders.paymentType, orders.paymentStatus,orders.paymentPlace,orders.gstn, orders.shipping_status FROM orders  
          WHERE orders.id = {$orderId}";
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="shipping_status" name="shipping_status" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[14] ?>" />
                </div>
                ...
                <div class="form-group col-md-6">
                  <label for="subTotal" class="control-label">Total Amount</label>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="number" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" value="<?php echo 0; //$data[6]; 
                                                                                                                                              ?>" />
                </div>
                <!-- <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="paymentType" id="paymentType">
                    <option value="">~~SELECT~~</option>
                    <option value="Cash On Delivery" <?php if ($data[10] == "Cash On Delivery") {
                                                        echo "selected";
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="paymentStatus" id="paymentStatus">
                    <option value="">~~SELECT~~</option>
                    <option value="Full Payment" <?php if ($data[11] == "Full Payment") {
                                                    echo "selected";
                                                  } ?>>Full Payment</option>
                    <option value="Advance Payment" <?php if ($data[11] == "Advance Payment") {
                                                      echo "selected";
                                                    } ?>>Advance Payment</option>
                    <option value="No Payment" <?php if ($data[11] == "No Payment") {
                                                  echo "selected";
                                                } ?>>No Payment</option>
                  </select>
                </div>
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="paymentPlace" id="paymentPlace">
                    <option value="">~~SELECT~~</option>
                    <option value="In Pakistan" <?php if ($data[12] == "In Pakistan") {
                                                  echo "selected";
                                                } ?>>In Pakistan</option>
                    <option value="Out Of Pakistan" <?php if ($data[12] == "Out Of Pakistan") {
                                                      echo "selected";
                                                    } ?>>Out Of Pakistan</option>
                  </select>
                </div>
